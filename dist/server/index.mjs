...
let metadata = {
  ...
  description: "A powerful online Markdown to PDF converter with live preview, templates, and export options. Privacy-first — everything runs in your browser.",
...
function RootLayout({
  ...
  return /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("html", { lang: "en", "data-theme": "dark", suppressHydrationWarning: true, children: [
