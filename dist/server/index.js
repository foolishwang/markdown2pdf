globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/brainfuck-7Y-n1rbw.js","assets/gherkin-CrPsa70H.js","assets/html2pdf-CA6QSuAs.js","assets/mscgen-DD8MfPK_.js","assets/properties-DbrLdiq4.js","assets/q-kmuB9EE5.js","assets/tiddlywiki-BxFnp3Ql.js","assets/tiki-C1EN214O.js","assets/troff-DBDqSHPe.js","assets/index-ItLbB7cG.js","assets/index-DDBjMRLl.js","assets/index-BBV_3UwV.js","assets/index-BMX1DPUq.js","assets/index-D4ifmlGJ.js","assets/index-cVYxXyx9.js","assets/index-CluhditU.js","assets/index-M3-24aeJ.js","assets/index-2RritJWq.js","assets/index-D6OlBhoQ.js","assets/index-BY7cMYqL.js","assets/index-BPhdmLhD.js","assets/index-BE1MoeCC.js","assets/index-CEHfheUD.js","assets/index-C2crvfI9.js","assets/index-BkfKJata.js","assets/asn1-EdZsLKOL.js","assets/clike-B9uivgTg.js","assets/clojure-BMjYHr_A.js","assets/cobol-CWcv1MsR.js","assets/coffeescript-S37ZYGWr.js","assets/crystal-SjHAIU92.js","assets/css-BnMrqG3P.js","assets/cypher-C_CwsFkJ.js","assets/d-pRatUO7H.js","assets/dockerfile-dfSVSzlD.js","assets/dylan-DwRh75JA.js","assets/ecl-Cabwm37j.js","assets/eiffel-CnydiIhH.js","assets/erlang-BNw1qcRV.js","assets/factor-UTrizBDB.js","assets/forth-Ffai-XNe.js","assets/fortran-DYz_wnZ1.js","assets/gas-Bneqetm1.js","assets/groovy-D9Dt4D0W.js","assets/haskell-Cw1EW3IL.js","assets/haxe-H-WmDvRZ.js","assets/idl-BEugSyMb.js","assets/javascript-iXu5QeM3.js","assets/julia-DuME0IfC.js","assets/livescript-BwQOo05w.js","assets/lua-BgMRiT3U.js","assets/mirc-CjQqDB4T.js","assets/mllike-CXdrOF99.js","assets/modelica-Dc1JOy9r.js","assets/mumps-BT43cFF4.js","assets/nginx-DdIZxoE0.js","assets/nsis-7BAWO3vo.js","assets/octave-Ck1zUtKM.js","assets/oz-BzwKVEFT.js","assets/pascal--L3eBynH.js","assets/perl-CdXCOZ3F.js","assets/pig-CevX1Tat.js","assets/powershell-CFHJl5sT.js","assets/protobuf-ChK-085T.js","assets/pug-DeIclll2.js","assets/puppet-DMA9R1ak.js","assets/python-BuPzkPfP.js","assets/r-B6wPVr8A.js","assets/ruby-B2Rjki9n.js","assets/sas-B4kiWyti.js","assets/scheme-C41bIUwD.js","assets/shell-CjFT_Tl9.js","assets/sieve-C3Gn_uJK.js","assets/smalltalk-CnHTOXQT.js","assets/sparql-DkYu6x3z.js","assets/sql-D0XecflT.js","assets/stex-C3f8Ysf7.js","assets/stylus-B533Al4x.js","assets/swift-BzpIVaGY.js","assets/tcl-DVfN8rqt.js","assets/textile-CnDTJFAw.js","assets/ttcn-cfg-B9xdYoR4.js","assets/ttcn-CfJYG6tj.js","assets/turtle-B1tBg_DP.js","assets/vb-CmGdzxic.js","assets/vbscript-BuJXcnF6.js","assets/velocity-D8B20fx6.js","assets/verilog-C6RDOZhf.js","assets/vhdl-lSbBsy5d.js","assets/webidl-ZXfAyPTL.js","assets/xquery-DzFWVndE.js","assets/yacas-BJ4BC0dw.js","assets/z80-Hz9HOZM7.js"];
...
function setImageSecurityHeaders(headers, config2) {
...
function getDraftModeCookieHeader() {
  const state = _getState$2();
  const header2 = state.draftModeCookieHeader;
...
class ResponseCookies {
  ...
  get(name) {
    for (const header2 of this._headers.getSetCookie()) {
      const eq = header2.indexOf("=");
      if (eq === -1)
        continue;
      const cookieName = header2.slice(0, eq);
      if (cookieName === name) {
        const semi = header2.indexOf(";", eq);
        const raw = header2.slice(eq + 1, semi === -1 ? void 0 : semi);
        let value;
        try {
...
const locales = ["en", "zh", "ja", "fr", "de", "es"];
...
function middleware(request) {
  ...
  if (!targetLocale) {
    ...
    if (acceptLanguage) {
      const acceptedLocales = acceptLanguage.split(",").map((lang) => lang.split(";")[0].trim().substring(0, 2).toLowerCase());
...
const Resources = /* @__PURE__ */ ((React, deps, RemoveDuplicateServerCss2, precedence) => {
  ...
  __vite_rsc_react__,
  assetsManifest.serverResources["src/app/[locale]/layout.tsx"],
  RemoveDuplicateServerCss,
  "vite-rsc/importer-resources"
);
const app$5 = { "title": "MK2PDF — Markdown to PDF Editor | Privacy-First Converter", "description": "A powerful online Markdown to PDF converter with live preview, templates, and export options. Privacy-first — everything runs in your browser. No data leaves your machine." };
const header$5 = { "logoBadge": "Pro", "themeToggle": "Toggle theme" };
const toolbar$5 = { "upload": "📁 Import file", "uploadFormats": "MD, TXT, HTML, JSON, CSV, TSV", "templates": "📄 Templates", "export": "📥 Export", "exporting": "Generating..." };
const editor$5 = { "title": "✏️ Editor", "words": "words", "chars": "chars", "lines": "lines" };
const preview$5 = { "title": "👁️ Preview" };
const statusBar$5 = { "ready": "Ready", "shortcut": "Ctrl+S to export", "markdown": "Markdown", "multiExport": "Multi-format export", "encoding": "UTF-8" };
const toast$5 = { "fileLoaded": "{format} file converted to Markdown", "fileError": "Supported formats: Markdown, text, HTML, JSON, CSV, TSV", "exportSuccess": "{format} exported successfully!", "exportError": "Failed to export the file. Please try again.", "previewNotReady": "Preview not ready. Please try again." };
const modal$5 = { "title": "Export document", "filename": "Filename", "format": "Output Format", "formatHint": "Choose a browser-native format. PDF, HTML, DOC, RTF, TXT, MD, JSON, CSV, and XML are available.", "pageSize": "Page Size", "margin": "Margin (mm)", "quality": "Image Quality", "pdfOptions": "PDF options", "cancel": "Cancel", "download": "Download file", "generating": "Generating...", "formats": { "pdf": "PDF document (.pdf)", "html": "HTML page (.html)", "doc": "Word document (.doc)", "rtf": "Rich Text Format (.rtf)", "txt": "Plain text (.txt)", "md": "Markdown (.md)", "json": "Structured JSON (.json)", "csv": "CSV from tables (.csv)", "xml": "XML outline (.xml)" }, "sizeA4": "A4 (210 × 297 mm)", "sizeLetter": "Letter (8.5 × 11 in)", "qualityStandard": "Standard (80%)", "qualityHigh": "High (95%)", "qualityMax": "Maximum (100%)" };
const dragdrop$5 = { "message": "Drop a document to convert into Markdown" };
const welcome$5 = '# Welcome to MK2PDF ✨\n\nA powerful, privacy-first **Markdown to PDF** editor built with Next.js.\n\n---\n\n## Features\n\n- ✅ **Live Preview** — See your changes in real-time\n- ✅ **Rich Formatting** — Full GitHub Flavored Markdown support\n- ✅ **PDF Export** — Download high-quality PDFs instantly\n- ✅ **Templates** — Start with professional templates\n- ✅ **Dark/Light Mode** — Choose your preferred theme\n- ✅ **Privacy First** — Everything runs in your browser\n\n## Quick Start\n\nTry editing this text on the left panel! The preview will update instantly.\n\n### Code Blocks\n\n```typescript\ninterface Document {\n  title: string;\n  content: string;\n  createdAt: Date;\n}\n\nfunction createPdf(doc: Document): Promise<Blob> {\n  // Your PDF generation logic here\n  return generatePdf(doc);\n}\n```\n\n### Tables\n\n| Feature       | Status | Priority |\n| :------------ | :----: | :------: |\n| Live Preview  |   ✅   |   High   |\n| PDF Export    |   ✅   |   High   |\n| Templates     |   ✅   |  Medium  |\n| Dark Mode     |   ✅   |  Medium  |\n\n### Blockquotes\n\n> "The best way to predict the future is to create it."\n> — Peter Drucker\n\n### Task Lists\n\n- [x] Install MK2PDF\n- [x] Write your document\n- [ ] Export to PDF\n- [ ] Share with the world\n\n---\n\n*Made with ❤️ using Next.js, CodeMirror, and React Markdown*\n';
const en = {
  app: app$5,
  header: header$5,
  toolbar: toolbar$5,
...
const app$4 = { "title": "MK2PDF — Markdown 转 PDF 编辑器 | 隐私优先转换器", "description": "一个强大的在线 Markdown 转 PDF 转换器，支持实时预览、模板和导出选项。隐私优先 — 所有操作都在您的浏览器中运行。没有任何数据离开您的设备。" };
const header$4 = { "logoBadge": "专业版", "themeToggle": "切换主题" };
const toolbar$4 = { "upload": "📁 导入文件", "uploadFormats": "MD、TXT、HTML、JSON、CSV、TSV", "templates": "📄 模板", "export": "📥 导出", "exporting": "生成中..." };
const editor$4 = { "title": "✏️ 编辑器", "words": "词", "chars": "字符", "lines": "行" };
const preview$4 = { "title": "👁️ 预览" };
const statusBar$4 = { "ready": "就绪", "shortcut": "Ctrl+S 导出", "markdown": "Markdown", "multiExport": "多格式导出", "encoding": "UTF-8" };
const toast$4 = { "fileLoaded": "已将 {format} 文件转换为 Markdown", "fileError": "支持 Markdown、文本、HTML、JSON、CSV、TSV 格式", "exportSuccess": "{format} 导出成功！", "exportError": "导出失败，请重试。", "previewNotReady": "预览尚未准备好，请重试。" };
const modal$4 = { "title": "导出文档", "filename": "文件名", "format": "输出格式", "formatHint": "可直接导出为浏览器本地可生成的格式：PDF、HTML、DOC、RTF、TXT、MD、JSON、CSV、XML。", "pageSize": "页面大小", "margin": "边距 (毫米)", "quality": "图像质量", "pdfOptions": "PDF 选项", "cancel": "取消", "download": "下载文件", "generating": "生成中...", "formats": { "pdf": "PDF 文档 (.pdf)", "html": "HTML 页面 (.html)", "doc": "Word 文档 (.doc)", "rtf": "富文本 (.rtf)", "txt": "纯文本 (.txt)", "md": "Markdown (.md)", "json": "结构化 JSON (.json)", "csv": "表格 CSV (.csv)", "xml": "XML 大纲 (.xml)" }, "sizeA4": "A4 (210 × 297 毫米)", "sizeLetter": "信纸 (8.5 × 11 英寸)", "qualityStandard": "标准 (80%)", "qualityHigh": "高 (95%)", "qualityMax": "最高 (100%)" };
const dragdrop$4 = { "message": "拖放文件到这里，自动转换为 Markdown" };
const welcome$4 = "# 欢迎使用 MK2PDF ✨\n\n一个基于 Next.js 构建的强大、隐私优先的 **Markdown 转 PDF** 编辑器。\n\n---\n\n## 功能特点\n\n- ✅ **实时预览** — 实时查看您的更改\n- ✅ **丰富的格式** — 全面支持 GitHub 风格的 Markdown\n- ✅ **PDF 导出** — 立即下载高质量的 PDF 文件\n- ✅ **模板** — 从专业模板开始\n- ✅ **深色/浅色模式** — 选择您喜欢的主题\n- ✅ **隐私优先** — 一切都在您的浏览器中运行\n\n## 快速开始\n\n尝试在左侧面板中编辑此文本！预览将立即更新。\n\n### 代码块\n\n```typescript\ninterface Document {\n  title: string;\n  content: string;\n  createdAt: Date;\n}\n\nfunction createPdf(doc: Document): Promise<Blob> {\n  // 您生成 PDF 的逻辑\n  return generatePdf(doc);\n}\n```\n\n### 表格\n\n| 功能特点     | 状态 | 优先级 |\n| :----------- | :--: | :----: |\n| 实时预览     |  ✅  |   高   |\n| PDF 导出     |  ✅  |   高   |\n| 模板         |  ✅  |   中   |\n| 深色模式     |  ✅  |   中   |\n\n### 引用\n\n> “预测未来的最好方法就是创造未来。”\n> — 德鲁克\n\n### 任务列表\n\n- [x] 安装 MK2PDF\n- [x] 编写您的文档\n- [ ] 导出为 PDF\n- [ ] 与世界分享\n\n---\n\n*使用 Next.js、CodeMirror 和 React Markdown 精心制作 ❤️*\n";
const zh = {
  app: app$4,
  header: header$4,
  toolbar: toolbar$4,
  editor: editor$4,
  preview: preview$4,
  statusBar: statusBar$4,
  toast: toast$4,
  modal: modal$4,
  dragdrop: dragdrop$4,
  welcome: welcome$4
};
const app$3 = { "title": "MK2PDF — Markdown to PDF エディター | プライバシー優先", "description": "強力なオンラインMarkdown to PDFコンバーター。ライブプレビュー、テンプレート、エクスポート機能付き。プライバシー優先 — 全てブラウザ内で動作します。" };
const header$3 = { "logoBadge": "Pro", "themeToggle": "テーマ枠線" };
const toolbar$3 = { "upload": "📁 ファイルを読み込む", "uploadFormats": "MD, TXT, HTML, JSON, CSV, TSV", "templates": "📄 テンプレート", "export": "📥 エクスポート", "exporting": "生成中..." };
const editor$3 = { "title": "✏️ エディター", "words": "単語", "chars": "文字", "lines": "行" };
const preview$3 = { "title": "👁️ プレビュー" };
const statusBar$3 = { "ready": "準備完了", "shortcut": "Ctrl+S でエクスポート", "markdown": "Markdown", "multiExport": "マルチフォーマット出力", "encoding": "UTF-8" };
const toast$3 = { "fileLoaded": "{format} ファイルを Markdown に変換しました", "fileError": "対応形式: Markdown, text, HTML, JSON, CSV, TSV", "exportSuccess": "{format} のエクスポートが完了しました！", "exportError": "エクスポートに失敗しました。再試行してください。", "previewNotReady": "プレビューの準備ができていません。再試行してください。" };
const modal$3 = { "title": "ドキュメントをエクスポート", "filename": "ファイル名", "format": "出力形式", "formatHint": "PDF、HTML、DOC、RTF、TXT、MD、JSON、CSV、XML をブラウザ内で出力できます。", "pageSize": "用紙サイズ", "margin": "余白 (mm)", "quality": "画質", "pdfOptions": "PDF オプション", "cancel": "キャンセル", "download": "ファイルをダウンロード", "generating": "生成中...", "formats": { "pdf": "PDF ドキュメント (.pdf)", "html": "HTML ページ (.html)", "doc": "Word ドキュメント (.doc)", "rtf": "RTF ドキュメント (.rtf)", "txt": "プレーンテキスト (.txt)", "md": "Markdown (.md)", "json": "構造化 JSON (.json)", "csv": "表から CSV (.csv)", "xml": "XML アウトライン (.xml)" }, "sizeA4": "A4 (210 × 297 mm)", "sizeLetter": "レター (8.5 × 11 in)", "qualityStandard": "標準 (80%)", "qualityHigh": "高 (95%)", "qualityMax": "最高 (100%)" };
const dragdrop$3 = { "message": "ドキュメントをここにドロップして Markdown に変換" };
const welcome$3 = '# MK2PDF へようこそ ✨\n\nNext.js で構築された強力でプライバシー優先の **Markdown to PDF** エディター。\n\n---\n\n## 機能\n\n- ✅ **ライブプレビュー** — 変更をリアルタイムで確認\n- ✅ **リッチフォーマット** — GitHub Flavored Markdown を完全サポート\n- ✅ **PDF エクスポート** — 高品質なPDFを即座にダウンロード\n- ✅ **テンプレート** — プロフェッショナルなテンプレートから開始\n- ✅ **ダーク/ライトモード** — お好みのテーマを選択\n- ✅ **プライバシー優先** — 全てがブラウザ内で動作\n\n## クイックスタート\n\n左のパネルでこのテキストを編集してみてください！プレビューは即座に更新されます。\n\n### コードブロック\n\n```typescript\ninterface Document {\n  title: string;\n  content: string;\n  createdAt: Date;\n}\n\nfunction createPdf(doc: Document): Promise<Blob> {\n  // PDFを生成するロジック\n  return generatePdf(doc);\n}\n```\n\n### テーブル\n\n| 機能             | 状態 | 優先度 |\n| :--------------- | :--: | :----: |\n| ライブプレビュー |  ✅  |   高   |\n| PDF エクスポート |  ✅  |   高   |\n| テンプレート     |  ✅  |   中   |\n| ダークモード     |  ✅  |   中   |\n\n### 引用\n\n> "未来を予測する最良の方法は、それを創り出すことだ。"\n> — ピーター・ドラッカー\n\n### タスクリスト\n\n- [x] MK2PDFをインストールする\n- [x] ドキュメントを書く\n- [ ] PDFにエクスポートする\n- [ ] 世界と共有する\n\n---\n\n*Next.js、CodeMirror、React Markdownを使って精巧に作られています ❤️*\n';
const ja = {
  app: app$3,
  header: header$3,
  toolbar: toolbar$3,
...
const app$2 = { "title": "MK2PDF — Éditeur Markdown vers PDF | Confidentialité d'abord", "description": "Un puissant convertisseur Markdown vers PDF en ligne avec aperçu en direct, modèles et options d'exportation. La confidentialité d'abord — tout s'exécute dans votre navigateur." };
const header$2 = { "logoBadge": "Pro", "themeToggle": "Changer de thème" };
const toolbar$2 = { "upload": "📁 Importer un fichier", "uploadFormats": "MD, TXT, HTML, JSON, CSV, TSV", "templates": "📄 Modèles", "export": "📥 Exporter", "exporting": "Génération..." };
const editor$2 = { "title": "✏️ Éditeur", "words": "mots", "chars": "caractères", "lines": "lignes" };
const preview$2 = { "title": "👁️ Aperçu" };
const statusBar$2 = { "ready": "Prêt", "shortcut": "Ctrl+S pour exporter", "markdown": "Markdown", "multiExport": "Export multi-format", "encoding": "UTF-8" };
const toast$2 = { "fileLoaded": "Le fichier {format} a été converti en Markdown", "fileError": "Formats pris en charge : Markdown, texte, HTML, JSON, CSV, TSV", "exportSuccess": "Export {format} réussi !", "exportError": "Échec de l'export. Veuillez réessayer.", "previewNotReady": "L'aperçu n'est pas prêt. Veuillez réessayer." };
const modal$2 = { "title": "Exporter le document", "filename": "Nom de fichier", "format": "Format de sortie", "formatHint": "PDF, HTML, DOC, RTF, TXT, MD, JSON, CSV et XML sont générés localement dans le navigateur.", "pageSize": "Taille de page", "margin": "Marge (mm)", "quality": "Qualité d'image", "pdfOptions": "Options PDF", "cancel": "Annuler", "download": "Télécharger le fichier", "generating": "Génération...", "formats": { "pdf": "Document PDF (.pdf)", "html": "Page HTML (.html)", "doc": "Document Word (.doc)", "rtf": "Texte enrichi (.rtf)", "txt": "Texte brut (.txt)", "md": "Markdown (.md)", "json": "JSON structuré (.json)", "csv": "CSV depuis les tableaux (.csv)", "xml": "Plan XML (.xml)" }, "sizeA4": "A4 (210 × 297 mm)", "sizeLetter": "Lettre (8.5 × 11 in)", "qualityStandard": "Standard (80%)", "qualityHigh": "Élevée (95%)", "qualityMax": "Maximale (100%)" };
const dragdrop$2 = { "message": "Déposez un document ici pour le convertir en Markdown" };
const welcome$2 = "# Bienvenue sur MK2PDF ✨\n\nUn éditeur **Markdown vers PDF** puissant et respectueux de la vie privée, conçu avec Next.js.\n\n---\n\n## Fonctionnalités\n\n- ✅ **Aperçu en direct** — Visualisez vos modifications en temps réel\n- ✅ **Formatage riche** — Prise en charge complète du GitHub Flavored Markdown\n- ✅ **Export PDF** — Téléchargez instantanément des PDF de haute qualité\n- ✅ **Modèles** — Commencez avec des modèles professionnels\n- ✅ **Mode sombre/clair** — Choisissez votre thème préféré\n- ✅ **Confidentialité d'abord** — Tout s'exécute dans votre navigateur\n\n## Démarrage rapide\n\nEssayez de modifier ce texte dans le panneau de gauche ! L'aperçu se mettra à jour instantanément.\n\n### Blocs de code\n\n```typescript\ninterface Document {\n  title: string;\n  content: string;\n  createdAt: Date;\n}\n\nfunction createPdf(doc: Document): Promise<Blob> {\n  // Votre logique de génération PDF ici\n  return generatePdf(doc);\n}\n```\n\n### Tableaux\n\n| Fonctionnalité     | Statut | Priorité |\n| :----------------- | :----: | :------: |\n| Aperçu en direct   |   ✅   |  Élevée  |\n| Export PDF         |   ✅   |  Élevée  |\n| Modèles            |   ✅   | Moyenne  |\n| Mode sombre        |   ✅   | Moyenne  |\n\n### Citations\n\n> \"La meilleure façon de prédire l'avenir est de le créer.\"\n> — Peter Drucker\n\n### Listes de tâches\n\n- [x] Installer MK2PDF\n- [x] Rédiger votre document\n- [ ] Exporter en PDF\n- [ ] Partager avec le monde\n\n---\n\n*Conçu avec ❤️ en utilisant Next.js, CodeMirror et React Markdown*\n";
const fr = {
  app: app$2,
  header: header$2,
  toolbar: toolbar$2,
...
const app$1 = { "title": "MK2PDF — Markdown zu PDF Editor | Privatsphäre zuerst", "description": "Ein leistungsstarker Online-Konverter von Markdown zu PDF mit Live-Vorschau, Vorlagen und Exportoptionen. Privatsphäre an erster Stelle — alles läuft in Ihrem Browser ab." };
const header$1 = { "logoBadge": "Pro", "themeToggle": "Theme umschalten" };
const toolbar$1 = { "upload": "📁 Datei importieren", "uploadFormats": "MD, TXT, HTML, JSON, CSV, TSV", "templates": "📄 Vorlagen", "export": "📥 Exportieren", "exporting": "Generiere..." };
const editor$1 = { "title": "✏️ Editor", "words": "Wörter", "chars": "Zeichen", "lines": "Zeilen" };
const preview$1 = { "title": "👁️ Vorschau" };
const statusBar$1 = { "ready": "Bereit", "shortcut": "Strg+S zum Exportieren", "markdown": "Markdown", "multiExport": "Mehrformat-Export", "encoding": "UTF-8" };
const toast$1 = { "fileLoaded": "{format}-Datei wurde in Markdown umgewandelt", "fileError": "Unterstützte Formate: Markdown, Text, HTML, JSON, CSV, TSV", "exportSuccess": "{format} erfolgreich exportiert!", "exportError": "Export fehlgeschlagen. Bitte erneut versuchen.", "previewNotReady": "Vorschau noch nicht bereit. Bitte erneut versuchen." };
const modal$1 = { "title": "Dokument exportieren", "filename": "Dateiname", "format": "Ausgabeformat", "formatHint": "PDF, HTML, DOC, RTF, TXT, MD, JSON, CSV und XML werden direkt im Browser erzeugt.", "pageSize": "Seitengröße", "margin": "Rand (mm)", "quality": "Bildqualität", "pdfOptions": "PDF-Optionen", "cancel": "Abbrechen", "download": "Datei herunterladen", "generating": "Generiere...", "formats": { "pdf": "PDF-Dokument (.pdf)", "html": "HTML-Seite (.html)", "doc": "Word-Dokument (.doc)", "rtf": "Rich-Text-Format (.rtf)", "txt": "Textdatei (.txt)", "md": "Markdown (.md)", "json": "Strukturiertes JSON (.json)", "csv": "CSV aus Tabellen (.csv)", "xml": "XML-Gliederung (.xml)" }, "sizeA4": "A4 (210 × 297 mm)", "sizeLetter": "Brief (8.5 × 11 in)", "qualityStandard": "Standard (80%)", "qualityHigh": "Hoch (95%)", "qualityMax": "Maximal (100%)" };
const dragdrop$1 = { "message": "Dokument hier ablegen, um es in Markdown umzuwandeln" };
const welcome$1 = '# Willkommen bei MK2PDF ✨\n\nEin leistungsstarker, privatsphäre-orientierter **Markdown-zu-PDF**-Editor, entwickelt mit Next.js.\n\n---\n\n## Funktionen\n\n- ✅ **Live-Vorschau** — Sehen Sie Ihre Änderungen in Echtzeit\n- ✅ **Umfangreiche Formatierung** — Volle Unterstützung für GitHub Flavored Markdown\n- ✅ **PDF-Export** — Laden Sie sofort hochwertige PDFs herunter\n- ✅ **Vorlagen** — Beginnen Sie mit professionellen Vorlagen\n- ✅ **Dunkel-/Hell-Modus** — Wählen Sie Ihr bevorzugtes Design\n- ✅ **Privatsphäre zuerst** — Alles läuft in Ihrem Browser ab\n\n## Schnellstart\n\nBearbeiten Sie einfach diesen Text im linken Fenster! Die Vorschau wird sofort aktualisiert.\n\n### Code-Blöcke\n\n```typescript\ninterface Document {\n  title: string;\n  content: string;\n  createdAt: Date;\n}\n\nfunction createPdf(doc: Document): Promise<Blob> {\n  // Ihre PDF-Generierungslogik hier\n  return generatePdf(doc);\n}\n```\n\n### Tabellen\n\n| Funktion           | Status | Priorität |\n| :----------------- | :----: | :-------: |\n| Live-Vorschau      |   ✅   |   Hoch    |\n| PDF-Export         |   ✅   |   Hoch    |\n| Vorlagen           |   ✅   |  Mittel   |\n| Dunkel-Modus       |   ✅   |  Mittel   |\n\n### Zitate\n\n> "Der beste Weg, die Zukunft vorauszusagen, ist, sie zu erfinden."\n> — Peter Drucker\n\n### Aufgabenlisten\n\n- [x] MK2PDF installieren\n- [x] Ihr Dokument schreiben\n- [ ] Als PDF exportieren\n- [ ] Mit der Welt teilen\n\n---\n\n*Gemacht mit ❤️ unter Verwendung von Next.js, CodeMirror und React Markdown*\n';
const de = {
  app: app$1,
  header: header$1,
  toolbar: toolbar$1,
...
const app = { "title": "MK2PDF — Editor de Markdown a PDF | Privacidad al máximo", "description": "Un potente convertidor en línea de Markdown a PDF con vista previa en vivo, plantillas y opciones de exportación. Privacidad primero — todo se ejecuta en tu navegador." };
const header = { "logoBadge": "Pro", "themeToggle": "Cambiar tema" };
const toolbar = { "upload": "📁 Importar archivo", "uploadFormats": "MD, TXT, HTML, JSON, CSV, TSV", "templates": "📄 Plantillas", "export": "📥 Exportar", "exporting": "Generando..." };
const editor = { "title": "✏️ Editor", "words": "palabras", "chars": "caracteres", "lines": "líneas" };
const preview = { "title": "👁️ Vista previa" };
const statusBar = { "ready": "Listo", "shortcut": "Ctrl+S para exportar", "markdown": "Markdown", "multiExport": "Exportación multiformato", "encoding": "UTF-8" };
const toast = { "fileLoaded": "El archivo {format} se convirtió a Markdown", "fileError": "Formatos compatibles: Markdown, texto, HTML, JSON, CSV, TSV", "exportSuccess": "¡{format} exportado correctamente!", "exportError": "Error al exportar. Inténtalo de nuevo.", "previewNotReady": "Vista previa no lista. Por favor intenta de nuevo." };
const modal = { "title": "Exportar documento", "filename": "Nombre de archivo", "format": "Formato de salida", "formatHint": "PDF, HTML, DOC, RTF, TXT, MD, JSON, CSV y XML se generan localmente en el navegador.", "pageSize": "Tamaño de página", "margin": "Margen (mm)", "quality": "Calidad de imagen", "pdfOptions": "Opciones de PDF", "cancel": "Cancelar", "download": "Descargar archivo", "generating": "Generando...", "formats": { "pdf": "Documento PDF (.pdf)", "html": "Página HTML (.html)", "doc": "Documento Word (.doc)", "rtf": "Texto enriquecido (.rtf)", "txt": "Texto plano (.txt)", "md": "Markdown (.md)", "json": "JSON estructurado (.json)", "csv": "CSV desde tablas (.csv)", "xml": "Esquema XML (.xml)" }, "sizeA4": "A4 (210 × 297 mm)", "sizeLetter": "Carta (8.5 × 11 in)", "qualityStandard": "Estándar (80%)", "qualityHigh": "Alta (95%)", "qualityMax": "Máxima (100%)" };
const dragdrop = { "message": "Suelta un documento aquí para convertirlo a Markdown" };
const welcome = '# Bienvenido a MK2PDF ✨\n\nUn potente y privado editor de **Markdown a PDF** construido con Next.js.\n\n---\n\n## Características\n\n- ✅ **Vista previa en vivo** — Mira tus cambios en tiempo real\n- ✅ **Formato rico** — Soporte completo para GitHub Flavored Markdown\n- ✅ **Exportación PDF** — Descarga PDFs de alta calidad al instante\n- ✅ **Plantillas** — Comienza con plantillas profesionales\n- ✅ **Modo oscuro/claro** — Elige tu tema preferido\n- ✅ **Privacidad primero** — Todo se ejecuta en tu navegador\n\n## Inicio rápido\n\n¡Intenta editar este texto en el panel izquierdo! La vista previa se actualizará al instante.\n\n### Bloques de código\n\n```typescript\ninterface Document {\n  title: string;\n  content: string;\n  createdAt: Date;\n}\n\nfunction createPdf(doc: Document): Promise<Blob> {\n  // Tu lógica de generación de PDF aquí\n  return generatePdf(doc);\n}\n```\n\n### Tablas\n\n| Característica       | Estado | Prioridad |\n| :------------------- | :----: | :-------: |\n| Vista previa en vivo |   ✅   |   Alta    |\n| Exportación PDF      |   ✅   |   Alta    |\n| Plantillas           |   ✅   |   Media   |\n| Modo oscuro          |   ✅   |   Media   |\n\n### Citas\n\n> "La mejor manera de predecir el futuro es creándolo."\n> — Peter Drucker\n\n### Listas de tareas\n\n- [x] Instalar MK2PDF\n- [x] Escribir tu documento\n- [ ] Exportar a PDF\n- [ ] Compartir con el mundo\n\n---\n\n*Hecho con ❤️ usando Next.js, CodeMirror y React Markdown*\n';
const es = {
  app,
  header,
  toolbar,
...
async function RootLayout(props) {
  ...
  return /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("html", { lang: locale, "data-theme": "dark", suppressHydrationWarning: true, children: [
    ...
    /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("body", { children: props.children })
  ] });
}
...
const metadataRoutes = [
  {
    ...
    fileDataBase64: ""
  }
];
...
async function _handleRequest(request, __reqCtx) {
  ...
  const middlewareFn = middleware ?? void 0;
